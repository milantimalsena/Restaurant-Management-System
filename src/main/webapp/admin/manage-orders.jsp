...
<div class="flex min-h-screen">
    <aside class="hidden w-72 shrink-0 border-r border-slate-200 bg-slate-900 text-white lg:flex lg:flex-col">
        ...
        <nav class="flex-1 space-y-2 px-4 py-6 text-sm font-semibold text-slate-300">
            ...
            <a href="${pageContext.request.contextPath}/admin/manage-orders" class="flex items-center justify-between rounded-2xl bg-amber-500 px-4 py-3 text-slate-950">Manage Orders</a>
            <a href="${pageContext.request.contextPath}/admin/payment-confirmation" class="flex items-center justify-between rounded-2xl px-4 py-3 transition hover:bg-white/10 hover:text-white">Payment Confirmation</a>
