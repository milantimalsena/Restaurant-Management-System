<footer class="site-footer mt-5">
	<div class="container py-5">
		<div class="row g-4 align-items-start">
			<div class="col-lg-4">
				<a href="${pageContext.request.contextPath}/public/home.jsp" class="d-inline-flex align-items-center gap-3 text-decoration-none mb-3">
					<span class="d-inline-flex align-items-center justify-content-center rounded-4 bg-dark text-white fw-bold" style="width: 48px; height: 48px;">SR</span>
					<div>
						<div class="text-uppercase text-secondary small fw-semibold letter-spacing">Smart Restaurant</div>
						<div class="h5 fw-bold mb-0 text-dark">Management System</div>
					</div>
				</a>
			...
			<div class="col-6 col-lg-3">
				...
				<div class="d-grid gap-2 text-secondary">
					...
					<div><i class="bi bi-envelope me-2 text-primary"></i> info@smartrestaurant.com</div>
		...
		<div class="border-top mt-4 pt-4 d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2 text-secondary small">
			<span>&copy; ${pageContext.request.contextPath != null ? 'Smart Restaurant' : 'Smart Restaurant'} 2026. All rights reserved.</span>
			<span>Built with JSP, Servlets, JDBC, MySQL, and Bootstrap 5.</span>
		</div>
	</div>
</footer>
